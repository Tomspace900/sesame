...
import { DOSSIER_STATUSES, type DossierType, type DossierStatus } from '@sesame/shared/types';
...
export function useDossierList() {
  ...
  const { search, debouncedSearch, handleSearchChange: baseHandleSearch, clearSearch } =
    useDebouncedSearch();
