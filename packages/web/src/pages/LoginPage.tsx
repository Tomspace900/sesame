    ...
    <div className="min-h-svh bg-sesame-bg flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sesame-text-muted font-body text-sm">
            Ton coffre-fort intelligent
          </p>
        </div>
          ...
          {state === 'success' ? (
            <div className="text-center py-4">
              <div
                ...
                role="status"
              >
                <Icon icon={CheckmarkCircle02Icon} size={20} color="#2A241F" strokeWidth={2} aria-hidden={true} />
            ...
            >
              ...
              {state === 'error' && (
                <div
                  ...
                  role="alert"
                >
                  <Icon icon={Alert02Icon} size={16} color="#FF0055" strokeWidth={2} aria-hidden={true} />
              ...
              >
                {state === 'loading' ? (
                  <>
                    <Icon icon={Loading03Icon} size={18} color="currentColor" strokeWidth={2} aria-hidden={true} />
                    Envoi en cours...
                  </>
                ) : (
