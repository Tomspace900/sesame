  ...
  ],
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-sesame-text bg-transparent text-sesame-text",
      },
    },
    defaultVariants: {
      variant: "detected",
...
export function Badge({ className, variant, children, ...props }: BadgeProps): React.JSX.Element {
  return (
