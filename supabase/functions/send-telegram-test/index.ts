...
const logger = createLogger("send-telegram-test");
...
Deno.serve(async (req: Request) => {
  ...
  logger.info(
    `Sending test message to ${profile.telegram_chat_id} for user ${user.id}`,
  );
  ...
  logger.success(`Target reached successfully`);
